...
# ==================== ТАБЛИЦА ТАРИФОВ (ОБНОВЛЕНА) ====================
CITY_RATES = {
    'Екатеринбург': 391, 'Каменск-Уральский': 428, 'Томск': 460,
    'Красноярск': 428, 'Кемерово': 428, 'Иркутск': 487, 'Новосибирск': 428,
    'Барнаул': 428, 'Прокопьевск': 428, 'Южно-Сахалинск': 1100, 'Якутск': 610,
    'Ленинск-Кузнецкий': 487, 'Горно-Алтайск': 428, 'Бийск': 428, 'Рубцовск': 428,
    'Улан-Удэ': 402, 'Петропавловск-Камчатский': 1100, 'Бердск': 487, 'Абакан': 428,
    'Ангарск': 423, 'Асбест': 428, 'Ачинск': 428, 'Белогорск': 706, 'Благовещенск': 423,
    'Братск': 403, 'Владивосток': 480, 'Забайкальск': 707, 'Канск': 428,
    'Комсомольск-на-Амуре': 423, 'Курган': 420, 'Кызыл': 428, 'Находка': 750,
    'Новокузнецк': 428, 'Новоуральск': 428, 'Норильск': 428, 'Первоуральск': 428,
    'Тобольск': 635, 'Тюмень': 675, 'Уссурийск': 1177, 'Хабаровск': 482, 'Чита': 423,
    'Юрга': 488, 'Апатиты': 495, 'Арзамас': 482, 'Астрахань': 428, 'Бор': 482,
    'Борисоглебск': 482, 'Воркута': 482, 'Елец': 482, 'Железногорск': 495,
    'Калуга': 482, 'Кимры': 482, 'Кирово-Чепецк': 482, 'Клинцы': 482, 'Кольчугино': 482,
    'Ливны': 482, 'Липецк': 482, 'Лиски': 482, 'Магнитогорск': 545, 'Мурманск': 440,
    'Муром': 482, 'Мценск': 482, 'Нижний Новгород': 428, 'Новомосковск': 482,
    'Оренбург': 482, 'Переславль-Залесский': 535, 'Плесецк': 482, 'Рославль': 482,
    'Россошь': 482, 'Рыбинск': 482, 'Ставрополь': 482, 'Тверь': 545, 'Тула': 482,
    'Узловая': 482, 'Усинск': 482, 'Шуя': 482, 'Щекино': 482, 'Ярославль': 428,
    'Минусинск': 1050, 'Черногорск': 963, 'Усолье-Сибирское': 900, 'Нариманов': 963,
    'Артем': 551, 'Березовский': 749, 'Верхняя Пышма': 749, 'Шелехов': 749,
    'Кола': 963, 'Североморск': 963, 'Елизово': 1100, 'Северск': 460, 'Московский': 675,
    'Биробиджан': 900, 'Тутаев': 428, 'Обнинск': 595, 'Брянск': 545, 'Серпухов': 545,
    'Подольск': 545, 'Орёл': 545, 'Рязань': 545, 'Тамбов': 545, 'Воронеж': 545,
    'Сургут': 545, 'Дзержинск': 595, 'Иваново': 545
}

CITY_MINIMUM = {
    'Екатеринбург': 2, 'Каменск-Уральский': 2, 'Томск': 2, 'Красноярск': 2,
    'Кемерово': 2, 'Иркутск': 2, 'Новосибирск': 2, 'Барнаул': 2, 'Прокопьевск': 2,
    'Южно-Сахалинск': 1, 'Якутск': 2, 'Ленинск-Кузнецкий': 2, 'Горно-Алтайск': 3,
    'Бийск': 2, 'Рубцовск': 2, 'Улан-Удэ': 2, 'Петропавловск-Камчатский': 1,
    'Бердск': 2, 'Абакан': 2, 'Ангарск': 2, 'Асбест': 2, 'Ачинск': 2, 'Белогорск': 2,
    'Благовещенск': 2, 'Братск': 2, 'Владивосток': 2, 'Забайкальск': 2, 'Канск': 3,
    'Комсомольск-на-Амуре': 2, 'Курган': 2, 'Кызыл': 3, 'Находка': 2, 'Новокузнецк': 2,
    'Новоуральск': 2, 'Норильск': 3, 'Первоуральск': 2, 'Тобольск': 1, 'Тюмень': 1,
    'Уссурийск': 1, 'Хабаровск': 2, 'Чита': 2, 'Юрга': 2, 'Апатиты': 2, 'Арзамас': 2,
    'Астрахань': 2, 'Бор': 2, 'Борисоглебск': 2, 'Воркута': 2, 'Елец': 2, 'Железногорск': 2,
    'Калуга': 2, 'Кимры': 2, 'Кирово-Чепецк': 2, 'Клинцы': 2, 'Кольчугино': 2,
    'Ливны': 2, 'Липецк': 2, 'Лиски': 2, 'Магнитогорск': 2, 'Мурманск': 2, 'Муром': 2,
    'Мценск': 2, 'Нижний Новгород': 2, 'Новомосковск': 2, 'Оренбург': 2,
    'Переславль-Залесский': 2, 'Плесецк': 2, 'Рославль': 2, 'Россошь': 2, 'Рыбинск': 2,
    'Ставрополь': 2, 'Тверь': 2, 'Тула': 2, 'Узловая': 2, 'Усинск': 2, 'Шуя': 2,
    'Щекино': 2, 'Ярославль': 2, 'Минусинск': 2, 'Черногорск': 2, 'Усолье-Сибирское': 3,
    'Нариманов': 2, 'Артем': 2, 'Березовский': 3, 'Верхняя Пышма': 3, 'Шелехов': 3,
    'Кола': 2, 'Североморск': 2, 'Елизово': 2, 'Северск': 2, 'Московский': 2,
    'Биробиджан': 3, 'Тутаев': 3, 'Обнинск': 2, 'Брянск': 2, 'Серпухов': 2, 'Подольск': 2,
    'Орёл': 2, 'Рязань': 2, 'Тамбов': 2, 'Воронеж': 2, 'Сургут': 2, 'Дзержинск': 2,
    'Иваново': 2
}
